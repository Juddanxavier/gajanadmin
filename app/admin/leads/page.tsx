...
function LeadsPageContent() {
  ...
  const [stats, setStats] = useState<any>(null); // Quick type
  ...
  // Load stats once or when leads change significantly (e.g. status update)
  useEffect(() => {
      loadStats();
  }, [leads.length]); // Refresh stats when lead count changes, or generally could be separate.
